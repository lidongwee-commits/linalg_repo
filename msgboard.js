...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      '.mb-fab{position:fixed;right:22px;bottom:22px;z-index:99990;display:flex;align-items:center;gap:8px;',
      'padding:11px 16px;border:none;border-radius:30px;cursor:pointer;color:#fff;font-size:15px;font-weight:600;',
      'background:linear-gradient(135deg,#6366f1,#8b5cf6);box-shadow:0 8px 24px rgba(99,102,241,.45);',
      'transition:transform .2s,box-shadow .2s}.mb-fab:hover{transform:translateY(-2px);box-shadow:0 12px 30px rgba(99,102,241,.55)}',
      '.mb-fab .mb-fab-dot{width:9px;height:9px;border-radius:50%;background:#ffd166;box-shadow:0 0 0 4px rgba(255,209,102,.35)}',
      ...
      '@media (max-width:520px){.mb-fab{bottom:16px;right:16px;padding:10px 14px;font-size:14px}}'
    ].join('');
  ...
  window.initMsgBoard = function () {
    if (!COMMENTS_API_URL || COMMENTS_API_URL === 'YOUR_WORKER_URL_HERE') {
      ...
      warn.style.cssText = 'position:fixed;right:22px;bottom:22px;z-index:99990;max-width:280px;padding:14px 16px;border-radius:12px;background:#fffbeb;color:#b45309;font-size:13px;box-shadow:0 8px 24px rgba(0,0,0,.15)';
    ...
    fab.innerHTML = '<span class="mb-fab-dot"></span><span>💬 留言</span>';
